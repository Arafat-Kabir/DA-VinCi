...
davinci_as.setupParams(mvBlockDim=(16,2), fracWidth=8, maxLevel=0,
...
# Script parameters
outfile   = 'davinci_prog_lstm.bin'
outCfile  = 'davinci_prog_lstm.c'
cprogname = 'prog_lstm'
expfile   = 'davinci_prog_lstm_exp.bin'         # expected output in $readmemb() format
...
# vv_mov(vregR3, VVREG.O)     # R3 = Ft . Ct-1
# vv_mult(vregR1, vregR2)
# vv_mov(VVREG.S, VVREG.O)    # SREG = It . ~Ct
# vv_add(vregR3, VVREG.S)     # OREG = Ct = Ft . Ct-1 + It . ~Ct
# # tanh(Ct)
# vv_mov(VVREG.ACT, VVREG.O)
# vv_activ(ACTCODE.TANH)
# vv_mov(VVREG.S, VVREG.O)    # SREG = tanh(Ct)
# # Ht = Ot . tanh(Ct), then shift out
# vv_mult(vregR2, VVREG.S)
