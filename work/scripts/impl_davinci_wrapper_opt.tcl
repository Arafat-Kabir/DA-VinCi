...
set sources     "$picasoCtrl_sources \
                 ...
                 $top_dir/tb/davinci_wrapper_impl_opt.sv"
set top_module  davinci_wrapper
set incdirs     "$top_dir/lib  $top_dir/tb  $top_dir/DA-VinCi $top_dir/vvengine"
set constraints "$scripts_dir/constr_davinci_wrapper_opt.xdc"

set device      xcu55c-fsvh2892-2L-e     ;# Alveo U55c
...
source $scripts_dir/pblock-100p.tcl
place_design
...
write_checkpoint      -force step04-iteropt.dcp
report_timing_summary -file  step04-iteropt-timing.rpt
report_utilization    -file  step04-iteropt-util.rpt
